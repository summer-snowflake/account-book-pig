  ...
  context '管理ユーザーがログインしている場合' do
    ...
    shared_examples_for 'whether the task is not there' do
      context '昨日完了したタスクが3件あった場合' do
        before do
          create(:all_done_task, confirmed_on: yesterday, board_name: 'ボード名１', card_name: 'カード１')
          create(:all_done_task, confirmed_on: yesterday, board_name: 'ボード名１', card_name: 'カード２')
          create(:all_done_task, confirmed_on: yesterday, board_name: 'ボード名２', card_name: 'カード３')
        end
    ...
    context 'すでに完了したタスクがある場合' do
      before do
        card1 = attributes_for(:all_done_task, board_name: 'ボード名１', card_code: 'card1')
        card2 = attributes_for(:all_done_task, board_name: 'ボード名２', card_code: 'card2')
